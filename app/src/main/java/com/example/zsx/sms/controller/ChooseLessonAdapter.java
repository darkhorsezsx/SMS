...
import com.example.zsx.sms.app.BaseActivity;
...
public class ChooseLessonAdapter extends BaseAdapter {
    ...
    // 构造器
    public ChooseLessonAdapter(Context context,ArrayList<HashMap<String, Object>> list) {
    ...
    public static void setIsSelected(HashMap<Integer,Boolean> isSelected) {
        ChooseLessonAdapter.isSelected = isSelected;
    }
